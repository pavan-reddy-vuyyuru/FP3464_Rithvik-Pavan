abstract class Employee {
    ...
    public String contractInfo() {
        //1.here we should get the contract details which is in test case 3 output implement function accordinglyreturn String.format("%n%s is a %s . %s",name,employeeType(),contract.contractInfoFrom());
        return "HEre";
    }
}
